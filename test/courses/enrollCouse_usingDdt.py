...
import time
from pages.coursePageClass import coursePageClass
from ddt import ddt, data, unpack
import unittest, pytest
from utilities.readCSVFile import getCSVdata
...
class Test_register_courses(unittest.TestCase):
    ...
    @data(*getCSVdata("C:/Users/Cloud Analogy/PycharmProjects/Framework/data.csv"))
    @unpack
